...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder5" runat="Server">
    ...
    <div class="grid">
        <div class="grid" style="width: 100%;">
            ...
            <div style="background: #FFF; padding: 20px;">
                ...
                <div id="giohang_row">
                    ...
                    <div class="c10"></div>
                    <div class="total-payment " align="right"><span style="margin-right: 30px">Mã giảm giá:
                        <input style="background: #FFF; border: solid 1px #CCC; height: 30px; width: 90px; text-align: center" name="codegiamgia" id="codegiamgia" type="text"></span> Tổng cộng: <span id="totalcart">0 đ</span></div>
                </div>
                <div class="c10"></div>
            </div>
            <script>
     ...
     -->
                            ...
                            <div class="c5"></div>
                            <div class="contact_input">
                                <input name="sercurity" placeholder="Captcha *" type="text" id="sercurity" style="width: 100px" class="txt-cart notNull">
                        ...
                        <div class="flex-container">
                            ...
                            <div class="cell-1-2" style="text-align: right">
                                <input name="input" type="button" onclick="$('#contactform').submit()" class="btn-send-cart" value="Đặt món"></div>
                        </div>
                    </div>
                    <div class="c10"></div>
                    <div class="c10"></div>
