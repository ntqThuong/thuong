...
public class cls_GiaoVien
{
    ...
    public bool Linq_Them( string name, bool gioitinh, string bophan, string mail, string phone, string taikhoan, string pass)
    {
    ...
    public bool Linq_Sua(int giaovien_id, string name, bool gioitinh, string mail, string phone, string taikhoan, string pass)
    {
